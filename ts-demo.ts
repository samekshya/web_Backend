...
//create atype CarModel.

// -name : string, description: string

// create an innterface for a car with properties:
...
// let booleanVar: boolean = true;
// let numberVar: number = 42;
// let symbolVar:symbol = Symbol("unqiue");
// let nullVar: null = null;
// let undefinedVar: undefined = undefined;
...
//     console.log(`Hello, ${name}`);
// }
// greet(); //name is optiona; if default value
...
// // make: string or number, model: CarModel;
// // year: number,
// // type: CarType, and isElectric (optional) boolena or number or string.
